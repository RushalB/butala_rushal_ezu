"""butala_rushal_ezu URL Configuration
...
from courseinfo.views import (
    ...
    CourseList,
    SemesterList,
    InstructorDetail, SectionDetail, SemesterDetail, CourseDetail, RegistrationDetail, StudentDetail,
    InstructorCreate, SemesterCreate, SectionCreate, StudentCreate, RegistrationCreate, CourseCreate,
    InstructorUpdate, CourseUpdate, SemesterUpdate, RegistrationUpdate, SectionUpdate, StudentUpdate,
)
